...
- (void)viewDidLoad {
    ...
    UIView *noneDataView = [[UIView alloc] initWithFrame:CGRectMake(0, frameY+29.0f, 320.0f, 480.0f)];
    noneView = noneDataView;
    [self.view addSubview:noneDataView];
    UILabel *text = [[UILabel alloc] initWithFrame:CGRectMake(0, frameY+30.0f, 320.0f, 25.0f)];
