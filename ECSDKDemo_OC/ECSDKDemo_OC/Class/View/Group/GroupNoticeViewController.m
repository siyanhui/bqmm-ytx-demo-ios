...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([msg isKindOfClass:NSClassFromString(@"ECProposerMsg")] && ((ECProposerMsg*)msg).confirm != 2) {
        [self popConfirmSheet:msg];
    } else if ([msg isKindOfClass:NSClassFromString(@"ECInviterMsg")] && ((ECInviterMsg*)msg).confirm == 1) {
        [self popConfirmSheet:msg];
    }
}
