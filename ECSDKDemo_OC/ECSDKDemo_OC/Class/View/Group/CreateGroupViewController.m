...
-(void)prepareUI
{
    ...
    _groupName = [[UITextField alloc] initWithFrame:CGRectMake(50.0f, frameY+16.0f, 260.0f, 30.0f)];
    ...
    _groupNotice = [[UITextField alloc]initWithFrame:CGRectMake(50.0f, frameY+66.0f, 260.0f, 30.0f)];
    _groupNotice.placeholder = @"群组公告（选填）";
    ...
    _groupProvince = [[UITextField alloc] initWithFrame:CGRectMake(50.0f, frameY+116.0f, 260.0f, 30.0f)];
    ...
    _groupCity = [[UITextField alloc] initWithFrame:CGRectMake(50.0f, frameY+166.0f, 260.0f, 30.0f)];
    ...
    [button setFrame:CGRectMake(80.0f, frameY+206.0f, 160.0f, 30.0f)];
    ...
    UILabel *label5 = [[UILabel alloc] initWithFrame:CGRectMake(120.0f, frameY+246.0f, 80.0f, 30.0f)];
    label5.text = @"类型";
    ...
    {
        _publicGroup = [[UIImageView alloc] initWithFrame:CGRectMake(50.0f, frameY+286.0f, 20.0f, 20.0f)];
    ...
    {
        _authGroup = [[UIImageView alloc] initWithFrame:CGRectMake(150.0f, frameY+286.0f, 20.0f, 20.0f)];
    ...
    UIButton *createGroupBtn = [[UIButton alloc] initWithFrame:CGRectMake(10.0f, frameY+326.0f, 300.0f, 44.0f)];
