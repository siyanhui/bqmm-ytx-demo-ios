...
-(void)prepareUI {
    CGFloat frameY = 0.0f;
    UIImageView * bgImageView = [[UIImageView alloc]initWithFrame:CGRectMake(0.0f, frameY, 320.0f, 120.0f)];
    ...
    updateBtn.frame =CGRectMake(0.0f, playEarView.frame.origin.y+playEarView.frame.size.height+Group_Margin_Heigth, 320.0f, 50.0f);
    ...
    excOrderBtn.frame =CGRectMake(0.0f, updateBtn.frame.origin.y+updateBtn.frame.size.height+Group_Margin_Heigth, 320.0f, 50.0f);
    ...
    excNowNumBtn.frame =CGRectMake(0.0f, excOrderBtn.frame.origin.y+excOrderBtn.frame.size.height+Line_Margin_Heigth, 320.0f, 50.0f);
    ...
    aboutBtn.frame =CGRectMake(0.0f, excNowNumBtn.frame.origin.y+excNowNumBtn.frame.size.height+Group_Margin_Heigth, 320.0f, 50.0f);
...
-(UIView*)switchViewFrameY:(CGFloat)frameY andTag:(NSInteger)tag {
    UIView * view = [[UIView alloc]initWithFrame:CGRectMake(0.0f, frameY, 320.0f, 50.0f)];
